...
class WeatherWeekModel {
  ...
  factory WeatherWeekModel.fromRawJson(String str) =>
      WeatherWeekModel.fromJson(json.decode(str));
  ...
  factory WeatherWeekModel.fromJson(Map<String, dynamic> json) =>
      WeatherWeekModel(
        ...
        forecast: ForecastApi.fromJson(json["forecast"]),
      );
...
class ForecastApi {
  ...
  factory ForecastApi.fromRawJson(String str) =>
